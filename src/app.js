...
const FORTUNE_LINES = [
  ...
  "고민될 땐 더 끌리는 쪽으로. 식권은 오늘을 위해 존재한다.",
  "첫 숟갈엔 잠시 눈을 감아보라. 행운의 맛이 거기 있다.",
  "오늘 그대가 고른 메뉴, 누군가 따라 시킨다. 그대가 트렌드.",
  "배고픔은 최고의 조미료. 굶지 말고 꼭 챙겨 먹어라.",
  "오늘 점심값은 동료가, 행운은 그대가 가져간다.",
  "평소 그냥 지나치던 그 가게. 오늘은 문을 열어볼 때다.",
  "많이 웃은 점심시간이 오후의 능률을 두 배로 만든다.",
  "오늘의 한 끼는 절대 후회하지 않는다. 그냥 믿어라.",
];
