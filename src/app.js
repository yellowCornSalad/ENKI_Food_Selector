...
// ========== 오늘의 포춘쿠키 (랜덤 미니게임) ==========
// 음식 얘기 말고 진짜 하루 운세처럼 — 일·인연·돈·기회·마음가짐. 뽑을 때마다 랜덤.
const FORTUNE_LINES = [
  "망설였던 그 일, 오늘 한 발 내딛으면 운이 열린다.",
  "오늘 마주친 작은 우연이 큰 행운의 신호다.",
  "급할수록 돌아가라. 오늘은 신중함이 당신을 지킨다.",
  "오늘은 말을 아끼는 것이 가장 큰 지혜가 된다.",
  "예상치 못한 곳에서 반가운 소식이 날아든다.",
  "미뤄둔 일을 오늘 시작하면 의외로 술술 풀린다.",
  "가까운 사람에게 건넨 말 한마디가 큰 호감으로 돌아온다.",
  "오늘의 작은 실수는 아무도 기억하지 못한다. 당당하게 가라.",
  "평소와 다른 길로 가보면 좋은 일이 기다리고 있다.",
  "웃는 얼굴이 오늘 하루 가장 강력한 행운의 부적이다.",
  "오늘은 먼저 안부를 묻는 사람에게 복이 따른다.",
  "조급해 말 것. 좋은 일은 늘 조용히 다가온다.",
  "오늘 흘린 노력은 보이지 않아도 차곡차곡 쌓이고 있다.",
  "잠깐의 산책이 막혔던 생각을 시원하게 뚫어준다.",
  "오늘은 지갑을 닫는 것이 곧 버는 것이다.",
  "작은 친절 하나가 예상 밖의 큰 행운으로 이어진다.",
  "당신이 옳다고 믿는 방향, 오늘은 그대로 밀어붙여도 좋다.",
  "오늘 내린 결정은 시간이 지나 옳았음이 증명된다.",
  "잊고 지내던 인연에게서 연락이 올 운이다.",
  "오늘은 나를 위한 작은 사치 하나가 허락되는 날.",
  "참고 있던 한마디, 오늘은 꺼내도 좋은 날이다.",
  "깊게 한 번 숨을 쉬어라. 오늘의 평온은 거기서 시작된다.",
  "오늘은 생각보다 많은 사람이 당신을 응원하고 있다.",
  "충동을 한 번 참으면 내일의 당신이 고마워한다.",
  "서두르면 놓치고, 천천히 보면 답이 보이는 하루.",
  "막혔던 일이 뜻밖의 도움으로 풀리는 날이다.",
  "오늘은 결과보다 과정을 즐기는 자에게 운이 따른다.",
  "작은 약속도 가볍게 여기지 마라. 신뢰가 쌓이는 날.",
  "일찍 잠드는 오늘 밤이 어떤 보약보다 당신을 살린다.",
  "지금의 선택을 믿어라. 당신의 직감은 생각보다 정확하다.",
];
